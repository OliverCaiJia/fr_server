...
////        //todo::
////        $data = [];
////        $data['user_report_type_id'] = $reportType['id'];
////        $data['user_id'] = $userId;
////        $data['order_id'] = $userOrder['id'];
//
//
////        $result = OrderStrategy::reportBak($data);
///


        $order['order_no'] = $request->input('order_no');
        $order['report_type_nid'] = $request->input('report_type_nid');
        $chain = new DoReportOrderHandler($order);
