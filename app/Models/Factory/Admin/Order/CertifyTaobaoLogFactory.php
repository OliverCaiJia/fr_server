...
use App\Models\Orm\CertifyTaobaoLog;

class CertifyTaobaoLogFactory extends AbsModelFactory
{
    /**
    * 根据不同筛选条件查询多条数据
    * @param array $params
    ...
    */
    ...
    {
        return CertifyTaobaoLog::insertGetId($insertData);
    }
