...
{
    #商户编号
    const MERCHANTNO = '10000466938';
    //$merchantNo="10000466938";
    const PARENTMERCHANTNO = '10000466938';
    ...
    //服务器服务器回调地址
    const NOTIFYURL = 'http://uat.fruit.witlending.com/api/v1/user/payment/yibao/sync';

    //服务器页面回调地址
    const REDIRECTURL = 'http://uat.fruit.witlending.com/api/v1/user/payment/yibao/async';
