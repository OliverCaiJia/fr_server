...
class UserVipStrategy extends AppStrategy
{
     ...
     * @return array
     */
    public static function getUserOrderOtherParamsByParam($nid = '')
    {
        return [
            'order_type' => UserOrderFactory::getOrderType($nid),  //订单类型
            'payment_type' => UserOrderFactory::getPaymentType(),  //支付类型
            'amount' => UserVipFactory::getReVipAmountByNid($nid), //金额
        ];
    }
