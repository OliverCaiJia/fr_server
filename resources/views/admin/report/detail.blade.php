                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(isset($antiFraud->person_info->email) && $antiFraud->person_info->email != '')
                                            <span class="zhima">{{ $antiFraud->person_info->email }}</span>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $antiFraud->person_info->gender ?? '暂无数据' }}
                                        <span class="status">已三要素实名认证</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        {{ $antiFraud->person_info->idcard ?? '暂无数据' }}
                                        <span class="status">已三要素实名认证</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        {{ $antiFraud->person_info->mobile ?? '暂无数据' }}
                                        <span class="status">运营商已认证</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="control-label">运营商：</label></td>
                                    <td>{{ $antiFraud->person_info->carrier ?? '暂无数据' }}
                                        <span class="status">已三要素实名认证</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        @if($antiFraud->person_info->education_info->level == 0)
                                            未填写
                                        @elseif($antiFraud->person_info->education_info->level == 1)
                                            **毕业
                                        @elseif($antiFraud->person_info->education_info->level == 2)
                                            ××毕业
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="control-label">是否毕业：</label></td>
                                    <td>
                                        @if(isset($antiFraud->person_info->education_info->is_graduation) && $antiFraud->person_info->education_info->is_graduation != false)
                                            <span class="zhima">已毕业</span>
                                        @else
                                            暂无数据
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    <td><label class="control-label">身份证制证地：</label></td>
                                    <td>
                                        @if(isset($antiFraud->person_info->idcard_location))
                                            <span class="zhima">{{ $antiFraud->person_info->idcard_location }}</span>
                                        @else
                                            暂无数据
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    <td><label class="control-label">手机发卡地：</label></td>
                                    <td>
                                        @if(isset($antiFraud->person_info->mobile_location))
                                            <span class="zhima">{{ $antiFraud->person_info->mobile_location }}</span>
                                        @else
                                            暂无数据
                                        @endif
                                    </td>
                            ...
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    <td colspan="2">贷款群数量</td>
                                    <td colspan="2">{{ $antiFraud->risk_qqgroup->loan_groupcnt ?? '暂无数据' }}</td>
                                </tr>
                                <tr>
                                    <td colspan="2">羊毛群数量</td>
                                    <td colspan="2">{{ $antiFraud->risk_qqgroup->woolen_groupcnt ?? '暂无数据' }}</td>
                                </tr>
                                <tr>
                                    <td colspan="2">赌博群数量</td>
                                    <td colspan="2">{{ $antiFraud->risk_qqgroup->gambling_groupcnt ?? '暂无数据' }}</td>
                                </tr>
                                <tr>
                                    <td colspan="2">分期付款群数量</td>
                                    <td colspan="2">{{ $antiFraud->risk_qqgroup->installment_groupcnt ?? '暂无数据' }}</td>
                                </tr>
                                <tr>
                                    <td colspan="2">财务管理群数量</td>
                                    <td colspan="2">{{ $antiFraud->risk_qqgroup->financial_management_groupcnt ?? '暂无数据' }}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td> (ecommerceConsigneeAddress['region'] ?? '') .
                                        ecommerceConsigneeAddress['address']
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td> isset(ecommerceBaseInfo['yuebaoBalance']) ? ecommerceBaseInfo['yuebaoBalance']
                                        . '元' : '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td> (isset(huabeiInfo['huabeiAmount']) && !empty(huabeiInfo['huabeiAmount'])) ?
                                        huabeiInfo['huabeiAmount'] . '元' : '暂无数据'
                                    </td>
                                    <td><label class="control-label">借呗额度</label></td>
                                    <td> (isset(jiebeiInfo['jiebeiAmount']) && !empty(jiebeiInfo['jiebeiAmount'])) ?
                                        jiebeiInfo['jiebeiAmount'] . '元' : '暂无数据'
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    <td> ecommerceBindedBankCard['bankName'] .' '.
                                        bankCardTypeMap[ecommerceBindedBankCard['cardType']]
                                    </td>
                            ...
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td><label class="control-label">合计金额</label></td>
                                    <td colspan="2"> array_sum(array_column(huabeiEcommerceTradesSuccess, 'amount'))
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="6" class="text-center">暂无数据</td>
                            ...
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td><label class="control-label">合计金额</label></td>
                                    <td colspan="2"> array_sum(array_column(bankCardEcommerceTradesSuccess, 'amount'))
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="6" class="text-center">暂无数据</td>
                        ...
                        <div class="panel-body">
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"> multilateralLending->result_detail['loans_credibility'] ?? '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"> multilateralLending->result_detail['loans_settle_count'] ??
                                        '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">贷款逾期订单数(M0+)</td>
                                    <td colspan="2"> multilateralLending->result_detail['loans_overdue_count'] ??
                                        '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">贷款机构数</td>
                                    <td colspan="2"> multilateralLending->result_detail['loans_org_count'] ?? '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">消费金融类机构数</td>
                                    <td colspan="2"> multilateralLending->result_detail['consfin_org_count'] ?? '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">网络贷款类机构数</td>
                                    <td colspan="2"> multilateralLending->result_detail['loans_cash_count'] ?? '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">近1月贷款笔数</td>
                                    <td colspan="2"> multilateralLending->result_detail['latest_one_month'] ?? '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">近3月贷款笔数</td>
                                    <td colspan="2"> multilateralLending->result_detail['latest_three_month'] ??
                                        '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">近6月贷款笔数</td>
                                    <td colspan="2"> multilateralLending->result_detail['latest_six_month'] ?? '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">最近一次贷款时间</td>
                                    <td colspan="2"> multilateralLending->result_detail['loans_latest_time'] ?? '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">信用贷款时长</td>
                                    <td colspan="2"> multilateralLending->result_detail['loans_long_time'] ?? '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">历史贷款机构成功扣款笔数</td>
                                    <td colspan="2"> multilateralLending->result_detail['history_suc_fee'] ?? '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">历史贷款机构失败扣款笔数</td>
                                    <td colspan="2"> multilateralLending->result_detail['history_fail_fee'] ?? '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">近1月贷款机构成功扣款笔数</td>
                                    <td colspan="2"> multilateralLending->result_detail['latest_one_month_suc'] ??
                                        '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">近1月贷款机构失败扣款笔数</td>
                                    <td colspan="2"> multilateralLending->result_detail['latest_one_month_fail'] ??
                                        '暂无数据'
                                    </td>
                                </tr>
                                </tbody>
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td> isset(verifInfo['idcard_match_fund']) ? (verifInfo['idcard_match_fund'] ? '是' :
                                        '否' ) : '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="control-label">姓名是否与公积金数据匹配：</label></td>
                                    <td> isset(verifInfo['mobile_match_fund']) ? (verifInfo['mobile_match_fund'] ? '是' :
                                        '否' ) : '暂无数据'
                                    </td>
                                    <td><label class="control-label">手机号码是否与公积金数据匹配：</label></td>
                                    <td> isset(verifInfo['name_match_fund']) ? (verifInfo['name_match_fund'] ? '是' : '否'
                                        ) : '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="control-label">身份证号码是否与网银数据匹配：</label></td>
                                    <td> isset(verifInfo['idcard_match_onlinebank']) ?
                                        (verifInfo['idcard_match_onlinebank'] ? '是' : '否' ) : '暂无数据'
                                    </td>
                                    <td><label class="control-label">姓名是否与网银数据匹配：</label></td>
                                    <td> isset(verifInfo['mobile_match_onlinebank']) ?
                                        (verifInfo['mobile_match_onlinebank'] ? '是' : '否' ) : '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="control-label">手机号码是否与网银数据匹配：</label></td>
                                    <td colspan="3"> isset(verifInfo['name_match_onlinebank']) ?
                                        (verifInfo['name_match_onlinebank'] ? '是' : '否' ) : '暂无数据'
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"> isset(backInfoDetail['direct_black_type']) ?
                                        (backInfoDetail['direct_black_type'] ? '是' : '否' ) : '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td> isset(blacklistRecord['overdue_status']) ?
                                        overdue_status[blacklistRecord['overdue_status']] : '暂无数据'
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td><label class="control-label">最大逾期天数：</label></td>
                                    <td> isset(grayRecord['overdue_status']) ?
                                        overdue_status[grayRecord['overdue_status']] : '暂无数据'
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td> \App\Strategies\WandStrategy::getOrgTypeText(registerInfo['org_types']) ?:
                                        '暂无数据'
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td> isset(suspiciousMobile['information_sources']['org_type']) ?
                                        orgTypeMap[suspiciousMobile['information_sources']['org_type']] : '暂无数据'
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-condensed table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td><label class="control-label">机构类型：</label></td>
                                    <td> isset(suspiciousIdcard['information_sources']['org_type']) ?
                                        orgTypeMap[suspiciousIdcard['information_sources']['org_type']] : '暂无数据'
                                    </td>
                                </tr>
                                </tbody>
                            </table>
