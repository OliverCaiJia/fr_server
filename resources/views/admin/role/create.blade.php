        ...
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <a href="{{route('admin.role.index')}}">
                    <button class="btn btn-primary btn-sm" type="button"><i class="fa fa-home"></i> 角色管理</button>
                </a>
                <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                <form class="form-horizontal m-t-md" action="{{route('admin.role.store')}}" method="post">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-3">
                            <input name="description" class="form-control" rows="5" cols="20" required
                                   data-msg-required="请输入角色描述" value="{{ old('description') }}">
                            @if ($errors->has('description'))
                                <span class="help-block m-b-none"><i
                                            class="fa fa-info-circle"></i>{{$errors->first('description')}}</span>
                            @endif
                        </div>
                    </div>
                    <div class="hr-line-dashed m-t-sm m-b-sm"></div>
