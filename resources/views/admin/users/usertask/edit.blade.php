    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                <a href="{{route('admin.usertask.index')}}"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-home"></i>返回上层列表</button></a>
                <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2" style="width: 100px;height: 300px;">
                            <textarea style="min-height:270px;min-width:320px;max-height:270px;max-width:30px;">{{print_r($retrieve_req_data,true)}}</textarea>
                        </div>
                    </div>
                    <div class="hr-line-dashed m-t-sm m-b-sm"></div>
            </div>
