        ...
        <div class="main">
            ...
            <div class="data-list">
                ...
                <div class='showData1'>--}} {{--
                    <div>--}} {{--
                        ...
                        <select name="" id="work_time">--}} {{--
                            ...
                            <option value="2">一年以上</option>--}} {{--</select>--}} {{--
                ...
                <div class='showData1'>--}} {{--
                    <div>--}} {{--
                        ...
                        <select name="" id="month_salary">--}} {{--
                            ...
                            <option value="3">1万以上</option>--}} {{--</select>--}} {{--
                        <div class="arrow-right"> </div>--}} {{--</div>--}} {{--</div>--}}
                <div class='showData3'>
                    <div>
                ...
                <div>--}} {{--
                    <div>--}} {{--
                        <label for="">社保：</label>--}} {{--
                        <p class="radio-box" id='has_social_security'> <span @if(isset($data[ 'has_social_security']) && $data[ 'has_social_security']==1 ) class="active" @endif data-val='0'>有</span> <span @if(isset($data[ 'has_social_security']) && $data[ 'has_social_security']==0 ) class="active" @endif data-val='1'>无</span> </p>--}} {{--</div>--}} {{--</div>--}}
                <div>
                    <div>
                ...
                <div>--}} {{--
                    <div>--}} {{--
                        <label for="">信用卡：</label>--}} {{--
                        <p class="radio-box" id='has_creditcard'> <span @if(isset($data[ 'has_creditcard']) && $data[ 'has_creditcard']==1 ) class="active" @endif data-val='0'>有</span> <span @if(isset($data[ 'has_creditcard']) && $data[ 'has_creditcard']==0 ) class="active" @endif data-val='1'>无</span> </p>--}} {{--</div>--}} {{--</div>--}}
                <div>
                    <div>
                        <label for="">微粒贷：</label>
